...
class RestaurantApplicationTests3 {
    @Autowired
    ...
    class RegisterRestaurants {
        ...
        void test1() throws JsonProcessingException {
            ...
            // when
            Long restaurantId = registeredRestaurant.restaurantId;
        ...
        void test3() throws JsonProcessingException {
            ...
            assertNotNull(food4Response.getFoodId());
    ...
    class FoodName {
        ...
        void test1() throws JsonProcessingException {
            ...
            // when
            Long restaurantId = registeredRestaurant.getRestaurantId();
            ResponseEntity<Object> response = restTemplate.postForEntity(
                    "/restaurant/" + restaurantId + "/food/register",
                    request,
                    Object.class);
        ...
        void test4() throws JsonProcessingException {
            ...
            // when
            Long restaurant2Id = restaurantDto2.restaurantId;
